...
switch(semana){ //string correspondente ao dia da semana
    case 0:
...
document.getElementById("datacompleta").innerText = "Hoje é " + dias + "/" + mes + "/" + ano + ` - ${semanaEscrito}`

//string correspondente a parte do dia que é agora
if ((horas >= 00) && (horas < 06)) {   //madrugada
        document.body.style.background = "#330505a8";      
        document.getElementById("img").src = './assets/madrugada.png'   
        document.getElementById("msg").innerText = "Está de madrugada, você deveria estar descansando...";
    } else if ((horas >= 06) && (horas < 12)) { //manhã
        console.log("Manhã")
        document.body.style.background = "#cfcf1bdc";
        document.getElementById("img").src = './assets/manha.png'
        document.getElementById("msg").innerText = "Bom dia! Agora está uma bela manhã.";
    } else if ((horas >= 12) && (horas < 18)) { //tarde
        document.body.style.background = "Orange";
        document.getElementById("img").src = './assets/tarde.png';
        document.getElementById("msg").innerText = "Boa tarde!";

    } else if ((horas >= 18) && (horas < 24)) { //noite
        document.body.style.background = "Black";
        document.getElementById("img").src = './assets/noite.png'
        document.getElementById("msg").innerText = "O dia está quase acabando! Boa noite!";
    }
document.getElementById("hora").innerText = `O horário atual é ${horas}:${minutos}` 
